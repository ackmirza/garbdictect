...
weights = {
    'street': {
        'weights': WEIGHTS / 'garb_dictect_Street_YOLOv5l.pt',
        'url': 'https://github.com/ackmirza/garbdictect/download/garb_dictect_Street_YOLOv5l.pt'
    },
    'cctv': {
        'weights': WEIGHTS / 'garb_dictect_Float_800x752_to_640x640.pt',
        'url': 'https://github.com/ackmirza/garbdictect/download/garb_dictect_Float_800x752_to_640x640.pt'
    }
}
