    ...
    def load(self, load_pkl=False):
        ...
        for image in images:
            try:
                ...
                print(image, "some error may be, if you are using it for just ti check to predictions, visit https://github.com/ackmirza/garbdictect and drop the images there.")
        ...
        for video in videos:
            ...
            if os.path.isfile(gpx_path):
                ...
                try:
                    ...
                    print(video, "Errors, check if video file and GPX file are valid. If you are intend to check the predictions, visit https://github.com/ackmirza/garbdictect and drop the images there.")
            else:
